...
const Button = React.forwardRef(({ className, variant = "default", size = "default", ...props }, ref) => {
  ...
  // Apply variant classes with enhanced gradients
  if (variant === "default") {
    classes +=
    ...
    classes +=
      " border-2 border-gray-300 bg-white hover:bg-gray-50 hover:border-gray-400 text-gray-900 shadow-sm hover:shadow-md"
...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border shadow-lg backdrop-blur-sm bg-white/95 text-card-foreground border-white/30",
      className,
    )}
    {...props}
  />
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn("font-semibold tracking-tight leading-none", className)} {...props} />
))
...
const SelectItem = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-md py-2.5 pl-8 pr-2 text-sm outline-none focus:bg-gradient-to-r focus:from-indigo-50 focus:to-blue-50 focus:text-indigo-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 transition-all duration-150",
      className,
    )}
    {...props}
  >
...
// Placeholder for your actual API service
...
export default function ProfileEditForm({ initialData, departments, onCancel, onProfileUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessage =
        err.response?.data?.detail || err.response?.data?.message || "Failed to update profile. Please try again."
          ...
          <div className="relative group">
            <div className="flex overflow-hidden justify-center items-center w-40 h-40 bg-gradient-to-br from-indigo-100 via-blue-100 to-purple-100 rounded-full ring-4 ring-white shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:shadow-3xl">
              {profilePicturePreviewUrl ? (
                <img
                  src={profilePicturePreviewUrl || "/placeholder.svg"}
                  alt="Profile Preview"
          ...
          <div className="space-y-10">
            ...
            <div className="p-8 bg-gradient-to-br rounded-2xl border shadow-lg from-blue-50/50 to-indigo-50/30 border-blue-100/50">
              <h2 className="flex items-center mb-6 text-xl font-bold text-gray-800">
                <span className="flex justify-center items-center mr-3 w-10 h-10 text-indigo-600 bg-gradient-to-br from-indigo-100 to-blue-100 rounded-xl shadow-md">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div className="relative group">
                  <label
                    htmlFor="first_name"
                    className="flex gap-2 items-center mb-2 text-sm font-semibold text-gray-700 transition-colors duration-200 group-focus-within:text-indigo-600"
                  >
                    <User className="w-4 h-4" /> First Name
                  </label>
                  <div className="relative">
                    <span className="flex absolute inset-y-0 left-0 items-center pl-4 text-gray-500 pointer-events-none">
            ...
            <div className="p-8 bg-gradient-to-br rounded-2xl border shadow-lg from-purple-50/50 to-indigo-50/30 border-purple-100/50">
              <h2 className="flex items-center mb-6 text-xl font-bold text-gray-800">
                <span className="flex justify-center items-center mr-3 w-10 h-10 text-purple-600 bg-gradient-to-br from-purple-100 to-indigo-100 rounded-xl shadow-md">
            ...
            <div className="p-8 bg-gradient-to-br rounded-2xl border shadow-lg from-green-50/50 to-teal-50/30 border-green-100/50">
              <h2 className="flex items-center mb-6 text-xl font-bold text-gray-800">
                <span className="flex justify-center items-center mr-3 w-10 h-10 text-green-600 bg-gradient-to-br from-green-100 to-teal-100 rounded-xl shadow-md">
            ...
            <div className="p-8 bg-gradient-to-br rounded-2xl border shadow-lg from-yellow-50/50 to-orange-50/30 border-yellow-100/50">
              <h2 className="flex items-center mb-6 text-xl font-bold text-gray-800">
                <span className="flex justify-center items-center mr-3 w-10 h-10 text-yellow-600 bg-gradient-to-br from-yellow-100 to-orange-100 rounded-xl shadow-md">
            ...
            <div className="p-8 bg-gradient-to-br rounded-2xl border shadow-lg from-pink-50/50 to-purple-50/30 border-pink-100/50">
              <h2 className="flex items-center mb-6 text-xl font-bold text-gray-800">
                <span className="flex justify-center items-center mr-3 w-10 h-10 text-pink-600 bg-gradient-to-br from-pink-100 to-purple-100 rounded-xl shadow-md">
                ...
                {formData.skills.length > 0 && (
                  <div className="flex flex-wrap gap-3 mt-4">
                    {formData.skills.map((skill, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-4 py-2 text-sm font-semibold text-indigo-800 bg-gradient-to-r from-indigo-100 to-blue-100 rounded-full border shadow-sm border-indigo-200/50"
                      >
                        {skill}
                      </span>
                    ))}
