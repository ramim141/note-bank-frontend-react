...
import { User, Mail, Phone, GraduationCap, Building, Book, Calendar, Award, BookOpen, Bookmark, StarIcon, Heart, MessageCircle } from "lucide-react";
...
const ProfilePage = () => {
  ...
  // --- Main Page Layout ---
  return (
    <div className="p-6 pt-32 min-h-screen bg-white animate-gradient-x">
              ...
              <div className="overflow-hidden relative">
                ...
                <div className="flex relative z-10 flex-col items-center p-6 text-center">
                  <div className="relative mb-4 group">
                    <div className="flex justify-center items-center w-32 h-32 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-lg transition-all duration-700 transform hover:scale-110 hover:rotate-12">
                    ...
                    {/* Rating Badge */}
                    <div className="flex absolute -bottom-2 left-1/2 gap-1 justify-center items-center px-2 py-1 text-xs font-semibold text-white bg-gradient-to-r from-green-500 to-emerald-500 rounded-full border-2 border-white shadow-lg transition-all duration-300 transform -translate-x-1/2 hover:scale-110 hover:shadow-xl">
                      <span className="text-yellow-300">⭐</span>
                      <span>{(user?.average_rating_of_all_notes || 0).toFixed(1)}</span>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                {[
                  ...
                  },
                  {
                    ...
                    value: (user?.total_reviews_received ?? 0),
                    label: "Total Reviews",
                    color: "bg-orange-100",
                    textColor: "text-orange-600",
                  },
                  {
                    icon: StarIcon, // Placeholder icon
                    // value: "0.0",
                    value: (user?.average_rating_of_all_notes ?? 0).toFixed(1),
